...
After saving, Aiberm appears in the model picker. Choose a model — that selection also becomes the default for **new** sessions. A session that has already sent a request keeps the model recorded in its own log.
